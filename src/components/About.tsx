          ...
          <div className="animate-scale-in">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-gradient-gold p-1 rounded-lg">
                <img 
                  src="/frames-of-the-90s-touch/lovable-uploads/437ebaa5-78f3-4b21-bb33-e402c8686a1f.png"
              ...
              <div className="bg-gradient-gold p-1 rounded-lg">
                <img 
                  src="/frames-of-the-90s-touch/lovable-uploads/62745277-a3df-4594-ad1e-301b05d34173.png"
            ...
            <div className="bg-gradient-gold p-1 rounded-lg">
              <img 
                src="/frames-of-the-90s-touch/lovable-uploads/774e11d1-8267-4389-a1d5-60fb369277ed.png"
