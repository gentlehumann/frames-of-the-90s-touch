          ...
          <div className="animate-scale-in">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-gradient-gold p-1 rounded-lg">
                <img 
                  src="https://images.lovable.dev/870b91df-81e9-48bf-9203-b7ba31e7e258.png"
              ...
              <div className="bg-gradient-gold p-1 rounded-lg">
                <img 
                  src="https://images.lovable.dev/287e9086-6d57-46bf-aca8-39a4cc793b7d.png"
            ...
            <div className="bg-gradient-gold p-1 rounded-lg">
              <img 
                src="https://images.lovable.dev/c06b79a6-cb15-42a5-8ba2-19cbc9be7aee.png"
